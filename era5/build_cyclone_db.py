...
def main() -> None:
    ...
    print(f'> drop cyclones before {ERA5_MIN_YEAR-1} included (ERA5 specs)')
    dropped_indexes = cyclone_dataframe[cyclone_dataframe['year'] < ERA5_MIN_YEAR].index
