...
stats_dirname   = f'{common.MERGED_TENSOR_FILE_PREFIX}_{file_prefix}_{common.STATS_FILE_POSTFIX}'
stats_filename  = f'{common.MERGED_TENSOR_FILE_PREFIX}_{file_prefix}_{common.MERGED_TENSOR_FILE_POSTFIX}_{common.STATS_FILE_POSTFIX}.csv'
stats_file_path = path.join(common.MERGED_TENSOR_PARENT_DIR_PATH,\
...
for variable in Era5:
  ...
  print(f'> standardizing channel {variable.name.lower()} with mean:{mean} and stddev: {stddev}')
